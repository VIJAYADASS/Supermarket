...
# ✨ Features
  ...
  🚪 Final Page — go back to the shop or log out.
  🔒 Protected Routes — guests are redirected to login automatically.
  🌐 React Router DOM — every page has its own URL.

# 🛠️ Tech Stack
  - Technology: Purpose 
  - React.js UI components & state 
  - React Router DOM v6 Client-side routing 
  - Tailwind CSS v3: All styling (utility classes)
  - Context API Global cart & user state JSON file Product
...
Built with 💚 as a beginner React learning project.
